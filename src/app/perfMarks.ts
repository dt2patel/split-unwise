...
export type LaunchMark = 'runtime-ready' | 'principal-ready' | 'session-ready' | 'app-mounted' | 'home-content' | 'group-header' | 'group-content'
...
export function describeLaunch(record: LaunchRecord): string {
  const order: readonly LaunchMark[] = ['runtime-ready', 'principal-ready', 'session-ready', 'app-mounted', 'home-content', 'group-header', 'group-content']
