...
const routes: RouteRecordRaw[] = [
  { path: '/', redirect: '/tabs/home' },
  {
    ...
    children: [
      ...
      { path: 'home/expenses/new', name: 'home-expense-create', component: RoutePlaceholder },
      { path: 'groups/expenses/new', name: 'groups-expense-create', component: RoutePlaceholder },
      { path: 'activity/expenses/new', name: 'activity-expense-create', component: RoutePlaceholder },
      { path: 'account/expenses/new', name: 'account-expense-create', component: RoutePlaceholder },
