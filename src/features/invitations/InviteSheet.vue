...
import { IonBackButton, IonButton, IonButtons, IonContent, IonHeader, IonIcon, IonInput, IonPage, IonTitle, IonToolbar } from '@ionic/vue'
    ...
    <ion-content :fullscreen="true">
      <main class="invite-page">
        ...
        <section class="invite-card">
          <ion-input id="invite-email" v-model="email" class="invite-field" type="email" inputmode="email" autocomplete="email" label-placement="stacked" :placeholder="t('invite.emailPlaceholder')">
            <span slot="label" class="invite-field__label">{{ t('invite.targetEmail') }} <small>{{ t('invite.optional') }}</small></span>
          </ion-input>
