...
9. Perform real sign-in, profile bootstrap, group creation, invitation acceptance, sign-out/in persistence, expense add/edit/delete replay, immutable-history reads, shared comment add/delete replay, group and account activity reads, two-account balance reads, manual settlement record/replay/void/replay, and notification read/replay on the Spark path.
...
| Firestore rules / indexes | Audited Spark expense, comment/activity, manual-settlement, and private notification-read rules released successfully from source `6a655eadaa5580b7b1a486ff74c975ab20b86885`; existing indexes unchanged |
...
| Production URL / release | `https://split-unwise-aditya.web.app` and `https://split-unwise-aditya.firebaseapp.com`; Spark notification feature source `6a655eadaa5580b7b1a486ff74c975ab20b86885`; `/build-info.json` records the exact final release commit |
